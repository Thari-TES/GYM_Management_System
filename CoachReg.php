                            ...
                            <div class="row">
                                <div class="col-md-6 withgif1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 gif2" >
                                                <img src="assets/images/gif1.gif" height="300" class="gif" alt="">
                                            </div> 
                                    </div> 
                                        <div class="form-group">
...
$special_notes= $_POST['specialn'];
 ...
 $memreg = "INSERT INTO `coach_rej` ( `fname`, `lname`, `age`,`gender`,`nic`,  `contact_no`, `address`, `reg_date`, `qualification`, `special_notes`) 
                    VALUES ('$fname','$lname','$age','$gender','$nic','$contactNo','$address','$reg_date','$qualification','$special_notes')";
  ...
  if ($run_staff) {
           ...
           echo "<script> window.open('CoachReg.php')</script>"; 
      }
      else{
