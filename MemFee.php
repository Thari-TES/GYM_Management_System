                ...
                <div id="main-wrapper">
                                ...
                                <form class="form-horizontal" name="form" method="post" action="" id="form">    
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group" >
                                                    <label for="ename" class="col-sm-3 control-label">Member's ID</label>
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" name="mid" id="mid" placeholder="Enter Member's id" required >
                                                        
                                                    </div>
                                                </div>

                                                <div class="form-group" >
                                                    <label for="ename" class="col-sm-3 control-label">Member's Name</label>
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" name="mname" id="mname" placeholder="Enter Member's Name" onkeyup="checkmName()" required >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select class="form-control m-b-sm" name="package" id="package" onkeyup="Package()" onchange="Package()"  required>
                                        ...
                                        <div class="col-sm-6" style="margin-left:30%;">
                                                    ...
                                                    <!-- <div class="col-md-3">
                                                    <button type="submit"  name="addbill" id="addbill" onclick="add()" class="btn btn-primary btn-rounded">Add To Bill</button>
                                                    </div> -->
                    ...
                    <div class="row" id="printdiv">
                        <div class="invoice col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div class="row print-container1">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><span id="mname1"></span></td>
                                                        <td><span id="package1"></span></td>
...
<script>
    ...
    function myFunction() {
        ...
        function checkmName(){
            ...
            // enters a valid character
                ...
                document.getElementById("mname1").innerHTML = x;
                return true;
            }
            else{
        ...
        function checkPrice(){
         ...
         //package
         function Package() {
                var x = package.selectedOptions[0].text;
                document.getElementById("package1").innerHTML = x;
    ...
    <script>
            ...
            function isValid(){
                ...
                if( checkDate() && checkPrice() && checkmName()  ) {
                    return true;
                }
                else{
                    return false;
            ...
            function returnToPrevious (e) {
                ...
                if(!isValid()) {
                    ...
                    if(e.preventDefault) {
                        e.preventDefault();
                        alert("Member fee didn't Add. Please enter valid inputs.");
                    } else {
                        e.returnValue = false;
                    }
                }
    ...
    <?php
        ...
        $memfee = "INSERT INTO `memfee` ( `mname`,  `package`, `date`, `month` , `price`) 
                            VALUES ('$mname','$package','$date','$month' ,'$price')";

            
            $run_staff = mysqli_query($conn, $memfee );

        if ($run_staff) {
                echo "<script> alert('Member Fee Added successfully ')</script>";
