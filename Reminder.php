                                   ...
                                   <div class="row">
                                       <div class="col-md-6 withgif">
                                           <div class="form-group ">
                                                   <label for="ename" class="col-sm-2 control-label">Note</label>
                                                   <div class="col-md-6">
                                                   <textarea name="note" class="form-control" id="note" placeholder="Enter Notes" onkeyup="checkNotes()" ></textarea>
                                       ...
                                       <div class="col-md-4 " >
                                       <img src="assets/images/gif1.gif"  class="gif" alt="">
                                       </div> 
                                       </div> 
                                       ...
                                       <div class="col-sm-6" style="margin-left:20%;">
                                                   ...
                                                   <div class="col-md-3">
                                                   <button type="submit" name="add" id="add" class="btn btn-primary btn-rounded">Add</button>
                                                   </div>
                                ...
                                <div class="panel-body">
                                   <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            <a href="deleteNote.php?deleteNote=<?php echo $id; ?>">
...
<script>
        ...
        function checkNotes(){
            ...
            let notesError    =   document.getElementById("notesError"); 
             ...
             if (notesValue === ''){
            // if blank
                notesError.textContent = "Notes cannot be blank!";
            ...
            // enters a valid character
                ...
                notesError.style.color = "#ff1617";
                notesError.textContent = "Notes cannot have special characters!!";
                return false;
            }
        }
...
<script>
            ...
            function returnToPrevious (e) {
                ...
                if(!isValid()) {
                    ...
                    if(e.preventDefault) {
                        e.preventDefault();
                        alert("Reminder Note didn't Add. Please enter valid inputs.");
                    } else {
                        e.returnValue = false;
                    }
                }
    ...
    <?php
        ...
        $reminder = "INSERT INTO `reminder` ( `note`, `date`) 
                            VALUES ('$note','$date')";

            
            $run_staff = mysqli_query($conn, $reminder );

        if ($run_staff) {
                echo "<script> alert('Reminder Note Added successfully ')</script>";
                // echo "<script> window.open('dashboard.php')</script>"; 
            }
            else{
                echo "<script> alert('Reminder Note Didnt Added  ')</script>";
