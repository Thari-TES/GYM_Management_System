                                ...
                                <form class="form-horizontal" name="form" method="post" action="" id="form">     
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group" >
                                                ...
                                                <div class="form-group">
                                                        <label class="col-sm-3 control-label">Supplement Name</label>
                                                        <div class="col-sm-6">
                                                            <select class="form-control m-b-sm" name="supname" id="supname" onchange="supname1()" required>
...
<script>
    ...
    function myFunction() {
        ...
        function supname1() {
                ...
                console.log(x);
                document.getElementById("supname1").innerHTML = x;
    ...
    $sup_pay = "INSERT INTO `sup_payment` ( `mname`,  `supname`, `date`, `price`) 
                        VALUES ('$mname','$supname','$date','$price')";

        
        $run_staff = mysqli_query($conn, $sup_pay );

    if ($run_staff) {
            echo "<script> alert('Suppliment Bill Added successfully ')</script>";
            // echo "<script> window.open('dashboard.php')</script>"; 
        }
        else{
            echo "<script> alert('Suppliment Bill Didnt Added  ')</script>";
