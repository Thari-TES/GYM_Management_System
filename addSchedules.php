                                ...
                                <div class="row">
                                    <div class="col-md-6 withgif">
                                        ...
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-3 control-label">Member Name</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-3 control-label">Exercise Name</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-3 control-label">Sets</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-3 control-label">Reps</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                                    <label for="input-Default" class="col-sm-3 control-label">Rest Time</label>
                                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 " >
                                                <img src="assets/images/3.gif" height="300" class="gif" alt="">
                                                </div> 
                                    </div> 
