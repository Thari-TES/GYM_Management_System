<?php
    ...
    if(isset($_POST['username'])  && isset($_POST['password'])){
        ...
        $query = "SELECT   `password` ,`username`, `user_type` FROM `user` WHERE `username`='$username' AND `password`='$password'  AND `user_type`='coach'";
                    ...
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                ...
                                <form class="m-t-md" method="post" action="<?php $_SERVER["PHP_SELF"];?>" >
                                    ...
                                    <a href="admin_login.php" class="btn btn-default btn-block m-t-md">Login as Admin</a>
                                </form>
